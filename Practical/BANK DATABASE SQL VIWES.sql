...
SELECT *
FROM Bank_Transaction
WHERE Amount > 10000;SELECT * FROM High_Value_Transaction_View;CREATE VIEW Balance_Ranking_View AS
SELECT
    Account_No,
    Customer_ID,
    Account_Type,
...
SELECT *
FROM Account;DELETE FROM Simple_Account_View
WHERE Account_No = 10011;
SELECT *
FROM Account;SHOW FULL TABLES
